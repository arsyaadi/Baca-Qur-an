...
//    useEffect(()=> {
//        localStorage.setItem('item',JSON.stringify(nomor))
//    })
  ...
  return (
    ...
    
      {
        ...
        <div className='border rounded-lg justify-self-center w-11/12 md:w-4/5 bg-white py-3 shadow-xl mb-2'>
            ...
            <button onClick={() => toggle()}  className="border outline-teal-700 px-4 py-1 rounded-md mx-10 flex place-items-center  w-auto  mt-3 md:float-right md:w-auto md:-mt-16 md:mx-5 font-Nunito hover:scale-105 transition duration-300 text-slate-900"
            style={{
        ...
        </div>
        {
            ...
            return(
                ...
                <div className='border rounded-lg mx-auto w-11/12  md:w-4/5 bg-white px-2 py-5 shadow-xl my-1' key={
                    el.id}>
